  ...
  mount.innerHTML = `
    <nav id="_nav">
      <a href="index.html" class="nav-logo">
        <img src="https://vaimxhgqcdhjhdiaampa.supabase.co/storage/v1/object/public/EaglePips/5ea59b4e-0457-450f-bce1-b5389c0a97fa-1776493148502.png" style="height:56px;width:auto;object-fit:contain;flex-shrink:0;filter:drop-shadow(0 0 8px rgba(200,169,110,0.5)) brightness(1.2)" alt="EaglePips">
      </a>
